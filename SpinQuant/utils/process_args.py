...
def parser_gen():
    ...
    # GBS
    parser.add_argument("--gbs", action="store_true", help="Perform Gradual Binary Search")
    parser.add_argument("--eval", action="store_true", help="Compute eval test ppl")
    parser.add_argument("--resume_gs", action="store_true", help="Resume GBS")
    parser.add_argument('--start_bit', type=int, default=16,
