...
def load_quantized_model(model_path, wbits, group_size, cache_dir):
    ...
    with init_empty_weights():
        model = AutoModelForCausalLM.from_config(config=config,torch_dtype=torch.float16, trust_remote_code=True, cache_dir=cache_dir)
